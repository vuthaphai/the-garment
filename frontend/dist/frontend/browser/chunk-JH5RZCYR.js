...
// src/app/features/hr/nationality/nationality-list/nationality-list.component.ts
function NationalityListComponent_Conditional_15_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
...
function NationalityListComponent_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngSubmit", function NationalityListComponent_Conditional_15_Template_form_ngSubmit_3_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275conditionalCreate(8, NationalityListComponent_Conditional_15_Conditional_8_Template, 2, 0, "mat-error");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function NationalityListComponent_Conditional_15_Template_button_click_18_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.editingId() ? "Edit Nationality" : "Add Nationality", " ");
    \u0275\u0275advance();
...
function NationalityListComponent_th_19_Template(rf, ctx) {
  if (rf & 1) {
...
function NationalityListComponent_td_20_Template(rf, ctx) {
  if (rf & 1) {
...
function NationalityListComponent_th_22_Template(rf, ctx) {
  if (rf & 1) {
...
function NationalityListComponent_td_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 33);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function NationalityListComponent_th_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 34);
...
function NationalityListComponent_td_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 33);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function NationalityListComponent_th_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 34);
...
function NationalityListComponent_td_29_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 33);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function NationalityListComponent_th_31_Template(rf, ctx) {
  if (rf & 1) {
...
function NationalityListComponent_td_32_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "td", 33)(1, "button", 36);
    \u0275\u0275listener("click", function NationalityListComponent_td_32_Template_button_click_1_listener() {
    ...
    \u0275\u0275listener("click", function NationalityListComponent_td_32_Template_button_click_4_listener() {
      const row_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const ctx_r1 = \u0275\u0275nextContext();
...
function NationalityListComponent_tr_33_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 40);
  }
}
function NationalityListComponent_tr_34_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 41);
  }
}
function NationalityListComponent_Conditional_35_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 22);
    \u0275\u0275text(1, "No nationalities found");
    \u0275\u0275elementEnd();
  }
}
var NationalityListComponent = class _NationalityListComponent {
  ...
  save() {
    ...
    const action = id ? this.hrService.updateNationality(id, this.form.value) : this.hrService.createNationality(this.form.value);
    action.subscribe({
      next: () => {
  ...
  static {
    this.\u0275fac = function NationalityListComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NationalityListComponent)(\u0275\u0275directiveInject(HrService), \u0275\u0275directiveInject(NotificationService), \u0275\u0275directiveInject(MatDialog), \u0275\u0275directiveInject(FormBuilder));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NationalityListComponent, selectors: [["app-nationality-list"]], decls: 36, vars: 5, consts: [[1, "p-6"], [1, "flex", "items-center", "justify-between", "mb-6"], [1, "page-title"], ["mat-flat-button", "", "color", "primary", 3, "click"], [1, "card", "mb-4"], ["appearance", "outline", 1, "max-w-xs"], ["matInput", "", "placeholder", "Search nationality...", 3, "input"], ["matSuffix", ""], [1, "card", "mb-4", "border-2", "border-indigo-200"], [1, "card", "p-0", "overflow-hidden"], ["mat-table", "", 1, "w-full", 3, "dataSource"], ["matColumnDef", "no"], ["mat-header-cell", "", "class", "w-12", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "nativeName"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["matColumnDef", "foreignName"], ["matColumnDef", "description"], ["matColumnDef", "actions"], ["mat-header-cell", "", "class", "w-24", 4, "matHeaderCellDef"], ["mat-header-row", "", "class", "bg-slate-50", 4, "matHeaderRowDef"], ["mat-row", "", "class", "hover:bg-slate-50 transition-colors", 4, "matRowDef", "matRowDefColumns"], [1, "text-center", "py-12", "text-slate-400"], [1, "text-base", "font-semibold", "mb-4", "text-slate-700"], [1, "grid", "grid-cols-3", "gap-4", 3, "ngSubmit", "formGroup"], ["appearance", "outline"], ["matInput", "", "formControlName", "nativeName"], ["matInput", "", "formControlName", "foreignName"], ["matInput", "", "formControlName", "description"], [1, "col-span-3", "flex", "gap-2", "justify-end"], ["mat-stroked-button", "", "type", "button", 3, "click"], ["mat-flat-button", "", "color", "primary", "type", "submit"], ["mat-header-cell", "", 1, "w-12"], ["mat-cell", ""], ["mat-header-cell", ""], ["mat-header-cell", "", 1, "w-24"], ["mat-icon-button", "", "matTooltip", "Edit", 3, "click"], [1, "text-slate-500"], ["mat-icon-button", "", "matTooltip", "Delete", 3, "click"], [1, "text-red-400"], ["mat-header-row", "", 1, "bg-slate-50"], ["mat-row", "", 1, "hover:bg-slate-50", "transition-colors"]], template: function NationalityListComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h1", 2);
        \u0275\u0275text(3, "Nationality");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(4, "button", 3);
        \u0275\u0275listener("click", function NationalityListComponent_Template_button_click_4_listener() {
          return ctx.openForm();
        });
        \u0275\u0275elementStart(5, "mat-icon");
        \u0275\u0275text(6, "add");
        \u0275\u0275elementEnd();
        \u0275\u0275text(7, " Add Nationality ");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(8, "div", 4)(9, "mat-form-field", 5)(10, "mat-label");
        \u0275\u0275text(11, "Search");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(12, "input", 6);
        \u0275\u0275listener("input", function NationalityListComponent_Template_input_input_12_listener($event) {
        ...
        \u0275\u0275text(14, "search");
        \u0275\u0275elementEnd()()();
        \u0275\u0275conditionalCreate(15, NationalityListComponent_Conditional_15_Template, 22, 3, "div", 8);
        \u0275\u0275elementStart(16, "div", 9)(17, "table", 10);
        \u0275\u0275elementContainerStart(18, 11);
        \u0275\u0275template(19, NationalityListComponent_th_19_Template, 2, 0, "th", 12)(20, NationalityListComponent_td_20_Template, 2, 1, "td", 13);
        \u0275\u0275elementContainerEnd();
        \u0275\u0275elementContainerStart(21, 14);
        \u0275\u0275template(22, NationalityListComponent_th_22_Template, 2, 0, "th", 15)(23, NationalityListComponent_td_23_Template, 2, 1, "td", 13);
        \u0275\u0275elementContainerEnd();
        \u0275\u0275elementContainerStart(24, 16);
        \u0275\u0275template(25, NationalityListComponent_th_25_Template, 2, 0, "th", 15)(26, NationalityListComponent_td_26_Template, 2, 1, "td", 13);
        \u0275\u0275elementContainerEnd();
        \u0275\u0275elementContainerStart(27, 17);
        \u0275\u0275template(28, NationalityListComponent_th_28_Template, 2, 0, "th", 15)(29, NationalityListComponent_td_29_Template, 2, 1, "td", 13);
        \u0275\u0275elementContainerEnd();
        \u0275\u0275elementContainerStart(30, 18);
        \u0275\u0275template(31, NationalityListComponent_th_31_Template, 2, 0, "th", 19)(32, NationalityListComponent_td_32_Template, 7, 0, "td", 13);
        \u0275\u0275elementContainerEnd();
        \u0275\u0275template(33, NationalityListComponent_tr_33_Template, 1, 0, "tr", 20)(34, NationalityListComponent_tr_34_Template, 1, 0, "tr", 21);
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(35, NationalityListComponent_Conditional_35_Template, 2, 0, "div", 22);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance(15);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NationalityListComponent, [{
    type: Component,
    args: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NationalityListComponent, { className: "NationalityListComponent", filePath: "src/app/features/hr/nationality/nationality-list/nationality-list.component.ts", lineNumber: 113 });
})();
export {
  NationalityListComponent
};
//# sourceMappingURL=chunk-JH5RZCYR.js.map
